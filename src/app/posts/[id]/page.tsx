...
<h2 className="text-2xl font-bold text-center mt-10"> Post Not Found </h2>
    ...
    return (
        <div className="max-w-3xl mx-auto p-5">
            ...
            {post.image && (
                <Image src={post.image} alt={post.title} width={500} height={500}></Image>
            )}
