...
export default function Navbar() {
 ...
 return (
    <header className="text-[#38BDF8] body-font shadow-lg">
         <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
            <div className="flex-1 text-[#38BDF8]">
                <span>{currentDateTime}</span>

            </div>
<nav className="md:ml-auto flex-wrap items-center text-[#38BDF8] justify-center">
